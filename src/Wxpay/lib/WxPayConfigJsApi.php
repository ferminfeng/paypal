...
class WxPayConfigJsApi
{
    ...
    public function getConfig($config){
         ...
         * @var path
         */
        //VENDOR_PATH . 'payment' . DS . 'src' . DS . 'Wxpay' . DS . 'cert' . DS . 'H5' . DS .'apiclient_cert.pem'
        define('SSLCERT_PATH', $config['sslcert_path']);
        //VENDOR_PATH . 'payment' . DS . 'src' . DS . 'Wxpay' . DS . 'cert' . DS . 'H5' . DS .'apiclient_key.pem'
